...
public abstract class NettyRemotingAbstract {
    ...
    public void processRequestCommand(final ChannelHandlerContext ctx, final RemotingCommand cmd) {
        //processorTable在NettyRemotingServer.registerProcessor()进行初始化，key：RequestCode   value：NettyRequestProcessor
        //客户端发送消息，Broker接收消息，使用的是SendMessageProcessor处理器处理请求
